...
Naiad got around this by putting the whole structure of the dataflow graph in one place, and it was sort of a mess. We had a bunch of baked assumptions about everyone using `UInt64` values, and the only thing they could mean was "loop counter" and ... eesh. Ok, we aren't going to do that this time.
...
Let's just focus in on the part of our initial dataflow graph with the cycle in it:
