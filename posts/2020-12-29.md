...
1. [Convert input query intervals to those of minutes, hours, and days](converting-query-intervals-to-minutes-hours-and-days),
2. [Group and aggregate data by minutes, hours, and days](grouping-and-aggregate-data-by-minute-hour-and-day),
3. [Join input query intervals with aggregated data, with a final aggregation](join-queries-and-input-data-and-reduce).
