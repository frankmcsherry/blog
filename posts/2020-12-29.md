...
In this case, the input data come pre-sliced by time.
...
1. [Convert input query intervals to those of minutes, hours, and days](https://github.com/frankmcsherry/blog/blob/master/posts/2020-12-29.md#converting-query-intervals-to-minutes-hours-and-days),
...
3. [Join input query intervals with aggregated data, with a final aggregation](https://github.com/frankmcsherry/blog/blob/master/posts/2020-12-29.md#join-queries-and-input-data-and-reduce).
