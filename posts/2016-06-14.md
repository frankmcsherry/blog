...
1. They describe an attack, named *model inversion*, which "given the model and some demographic information about a patient, can predict the patient’s genetic markers."
...
2. They find that "for privacy budgets effective at preventing attacks, patients would be exposed to increased risk of stroke, bleeding events, and mortality."
...
> The paper's first observation is really just that dosing people with Warfarin based on their genetic markers may disclose information about their genetic markers to people who see the dose.
