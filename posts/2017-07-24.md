...
Notice that the x-axis, throughput, goes out *lots* farther than up above. We max out at 12.5 million elements per second. It's a pretty small change, but one that greatly affects how easy it is to compute the anwer.