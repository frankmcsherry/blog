...
Today we'll be writing a method for finding the edges in a directed graph that contribute to the shortest paths between query pairs of nodes. It's signature looks like this:
