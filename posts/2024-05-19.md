...
1. [Demonstrating Materialize with auction data]()
2. [Building an Auction loadgen from live random data]()
3. [Building live random data from just SQL]()
4. [All the SQL; really, just SQL]()
