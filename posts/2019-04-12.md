...
This is a pretty important quantity to understand whether releasing this information in the clear might have privacy risks. It is also a quantity that can be trivially reported, with very high accuracy, using differential privacy. Aside: I'm not aware of another formal privacy criterion that would permit this quantity, which is fundamentally about the relationship *among* individuals rather than a summary of individuals in isolation.
...
What about the potential social view of privacy violations? Do people care about privacy violations? Do they change their behavior because of perceived privacy risks? Would they not do so with better privacy mechanisms? These all seem like great questions for demographic research.

Unfortunately, it seems like there is a bit of a gap here. John's Tweetorial for example indicates that for 46% of 2010 US Census respondents, their quasi-identifiers can be *exactly* reconstructed from statistical information the US Census could (but won't) publish.

This is a serious number, almost half the population, with potentially serious consequences (quasi-identifier release). Instead, we have demographers LOL'ing at how exact reconstruction of the quasi-identifiers above for 46% of the 2010 respondents "isn't high accuracy".

![Shame](https://github.com/frankmcsherry/blog/blob/master/assets/demographers.png)

This is just embarassing. If I had the ability to crack 46% of the passwords of US Citizens, or naked photos of 46% of these demographers family members, you could be damned sure they would pay attention. Either these people don't understand what they are talking about (or maybe they do), or they just don't take it very seriously.

It would be great to have demographers understand the privacy characteristics and concerns of human populations, but maybe some new generation of demographers.
...
Differential privacy provides a formal basis for asking and answering questions whose privacy properties are challenging to justify otherwise.
...
I can't think of other statistical disclosure limitation techniques that allow such a clear response. Other mechanisms might randomize and release the source data, but the introduced entropy will increase the apparent number of uniquely identifiable individuals, unfairly over-reporting the threat. Differential privacy's ability to ask direct questions, and get direct answers with unbiased noise, has the potential to dramatically simplify some stastitical analyses.

#### Differential privacy improves inferences

The data that many demographers currently use, public use microdata released by the US Census, is not accurate. It is randomized and adjusted in various ways in order to improve privacy (at least since 1990). However, the mechanisms the US Census uses to do this are not public. Demographers who want to use these measurements and draw conclusions about the *true* underlying population must make guesses about the process (or, not uncommonly, just ignore the process).
...
Because the US Census could not report the specific processes they applied to the data, consumers of the data had no idea about the level of inaccuracy and could not evaluate it for themselves. Some number of conclusions resulted that did not reflect the true underlying data, and likely still today other conclusions have been drawn that are not representative; to the best of my understanding most demographers just don't know.
...
A detailed understanding of a statistical process is table stakes for drawing conclusions based observations of that process. It boggles my mind (and the minds of several colleagues) that this is not more of an issue with demographers. I would have imagined demographer *demanding* a clear explanation of the statistical processes in the name of proper science.
