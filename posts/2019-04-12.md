...
This is a serious number, almost half the population, with potentially serious consequences (quasi-identifier release). Instead, we have demographers LOL'ing at how exact reconstruction of quasi-identifiers for 46% of the 2010 respondents "isn't high accuracy".
