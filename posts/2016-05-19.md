...
The authors are right that I could have skipped calling them out on their shortcomings, but which would you prefer: civil but dishonest discourse, or candid and honest discourse? Should we just "teach the controversy"? The Fool's Gold paper has a position (the clue is in the name): it calls out several people by name for not understanding apparent issues with differential privacy.
...
Also, I'm guessing that "have fallen out of vogue" is code for "have substandard privacy guarantees". No one is talking about differential privacy because it is easy to use, it is interesting because it provides real and meaningful privacy guarantees.
...
### Part 1: "Differential Privacy should destroy utility—that’s what ensures privacy."
...
### Part 2: "We exaggerate the damage that Differential Privacy does to utility"
...
### Part 3: "We overlook the evolution in Differential Privacy that has permitted more data utility."
...
### Part 4: "There are methods other than adding LaPlace noise that satisfy pure Differential Privacy."
