**Note**: [the abomonation library](https://github.com/frankmcsherry/abomonation) has updated and improved in the time since this post. I've left the text unadjusted, but several things are now out of date.
