...
If you've read any of my earlier post on single-threaded graph processing, you might say "64 seconds?!? But, you know you can do that in about 5 seconds...".
...
![Counting degrees, badly vs radix](https://github.com/frankmcsherry/blog/blob/master/assets/radix.png)

I did this by putting a loop around the bits of code I wrote up above.

According to their web page, "X-Stream is a large and complex system, currently in the region of 15K lines of code and growing fast". I couldn't figure out how to make a pull request, but I have about 47 lines of Rust that might help.

### Conclusions

Here is where you might expect that I would make some snarky, unkind comments about how not everyone is right. Whatever; I was just as wrong (relatively) about how long pagerank should take as the X-Stream folks seem to have been about sorting. Who knows, maybe I am the one who is wrong about it.

Here is a bigger problem: in the big data processing session of one of the top computer systems conferences, no one (speaker, audience, me) knew how long it should take to sort some numbers. I mean, we laugh at those database people who can't unstick their capslock key, but at least they have this figured out.
