...
I think this is abotu how long X-Stream would need (modulo hardware), and Chaos should be 32x faster. Hump that.
...
A better condition for an edge `(src, dst)` at iteration `iter`
