...
This is just reporting the numbers, rather than actually traversing the data, sot it is pretty fast. User traces will get compacted at some point (probably Monday) and get us back to these single-digit latencies.
