...
Scanning across the 22 TPC-H queries, the numbers of records each query needs to maintain drops dramatically:

|    query | baseline   | primary indexes | delta queries |
|----------|-----------:|-----------:|-----------:|
| query 01 |         20 |         28 |         20 |
