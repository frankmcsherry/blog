...
There is a cute app called [projekt](https://itunes.apple.com/us/app/projekt/id1244456273) on the Apple app store (and perhaps other places as well). It is a fun game that shows you two 5x5 silhouettes and challenges you to find an arrangement of cubes in a 5x5x5 volume that cast the appropriate shadows (or, "projektions").
